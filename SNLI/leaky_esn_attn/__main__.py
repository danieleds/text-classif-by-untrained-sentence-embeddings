...
from SNLI.leaky_esn_attn.model import ESNModelSNLI
...
opt_space = {'attention_r': 1, 'attention_type': 'LinSelfAttention', 'density_in': (0.6490642394189948,), 'density_in_bw': (0.6745601715844801,), 'dropout': 0.7970124251550051, 'epochs': -200, 'leaking_rate': (0.38930217546173795,), 'leaking_rate_bw': (0.7738524701335754,), 'lr': 0.000138326471408694, 'mlp_hidden_size': 0, 'mlp_n_hidden': 0, 'n_attention': 256, 'n_batch': 128, 'num_layers': 1, 'reservoir_size': 3000, 'scale_in': (6.745137376597286,), 'scale_in_bw': (0.2725147494411861,), 'scale_rec': (0.04641425166402264,), 'scale_rec_bw': (0.49182066901748145,), 'weight_decay': 0.0012623295223805023}
