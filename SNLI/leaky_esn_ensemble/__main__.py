...
from SNLI.leaky_esn_ensemble.model import ESNModelSNLIEnsemble
...
# opt_space = {'reservoir_size': 10000, 'num_layers': 1, 'density_in': [0.16241617337111502], 'density_in_bw': [0.8462420388657149], 'scale_in': [1.0662463087328995], 'scale_in_bw': [15.456222270037319], 'scale_rec': [2.2755404117929725], 'scale_rec_bw': [0.6080324164867185], 'r_alpha': 100, 'leaking_rate': [0.3202944730755585], 'leaking_rate_bw': [0.15651948678628058], 'n_batch': 128, 'n_ensemble': 3}

# Best hyperparameters:
opt_space = {'density_in': (0.9994663972644349,), 'density_in_bw': (0.9393418781794324,), 'leaking_rate': (0.22944333996542265,), 'leaking_rate_bw': (0.10989214430128433,), 'n_batch': 128, 'num_layers': 1, 'r_alpha': 0.025117260751334494, 'reservoir_size': 2500, 'scale_in': (4.5582937987309595,), 'scale_in_bw': (52.96784665383114,), 'scale_rec': (0.3773615469556043,), 'scale_rec_bw': (0.005511545875084299,), 'n_ensemble': 3}
...
def evaluate(hp: dict, extra: ExtraArgs, trial_id=0) -> Tuple[float, GridCellMeasurements]:
    ...
    if extra.is_final_trials:
        ...
        filename = f'SNLI_leaky-esn-ensemble_{datet}_{trial_id}_{round(test_perf*100, 1)}.pt'
