...
# opt_space = {'reservoir_size': 10000, 'num_layers': 1, 'density_in': [0.16241617337111502], 'density_in_bw': [0.8462420388657149], 'scale_in': [1.0662463087328995], 'scale_in_bw': [15.456222270037319], 'scale_rec': [2.2755404117929725], 'scale_rec_bw': [0.6080324164867185], 'r_alpha': 100, 'leaking_rate': [0.3202944730755585], 'leaking_rate_bw': [0.15651948678628058], 'n_batch': 200}

# Best hyperparameters:
opt_space = {'density_in': (0.979579112327403,), 'density_in_bw': (0.5841900018321249,), 'dropout': 0.6865397273833402, 'leaking_rate': (0.23879665500567102,), 'leaking_rate_bw': (0.08660049406998288,), 'n_batch': 128, 'num_layers': 1, 'r_alpha': 0.0008613536159644131, 'reservoir_size': 10000, 'scale_in': (1.268067202671457,), 'scale_in_bw': (7.283686299742936,), 'scale_rec': (0.026586045793818507,), 'scale_rec_bw': (2.3052318562906335,)}
...
def evaluate(hp: dict, extra: ExtraArgs, trial_id=0) -> Tuple[float, GridCellMeasurements]:
    ...
    if extra.is_final_trials:
        ...
        filename = f'SMS_leaky-esn_{datet}_{trial_id}_{round(test_perf*100, 1)}.pt'
