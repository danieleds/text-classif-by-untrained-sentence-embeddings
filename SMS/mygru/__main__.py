...
from SMS.mygru.model import MyGRUModelSMS
...
opt_space = {'epochs': 25, 'lr': 0.0003236926600751418, 'n_batch': 128, 'reservoir_size': 96, 'weight_decay': 0.0002575604786643503}
...
def evaluate(hp: dict, extra: ExtraArgs, trial_id=0) -> Tuple[float, GridCellMeasurements]:
    ...
    model = MyGRUModelSMS(hp, logname=args.logname)
    ...
    if extra.is_final_trials:
        ...
        filename = f'SMS_mygru_{datet}_{trial_id}_{round(test_perf*100, 1)}.pt'
